...
function runTests() {
  ...
  const arr8 = ["apple", "banana", "cherry", "date"];
  const target8 = "cherry";
  ...
  const arr9 = [true, false, true, false];
  const target9 = false;
  ...
  try {
    ...
    console.log(`Test 10 - Error handling: PASS (${error.message})`);
  }
}
